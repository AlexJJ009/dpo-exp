"""
DPO Training script for Qwen3-4B-Base (v2 - strict preference pairs).

Trains on strict-filtered preference pairs from /data-1/dataset/dpo/dpo-4b-v2/dpo-4b-v2-pairs.jsonl
and saves checkpoint to /data-1/checkpoints/qwen3-4b-base-dpo-v2/.
...
# Force single-GPU training: without torchrun/accelerate, Transformers Trainer
# wraps the model in DataParallel when multiple GPUs are visible, which causes
# the primary GPU to hold full optimizer states + model replicas from all GPUs
# (~76 GiB on GPU 0 for a 4B model). Single-GPU avoids this entirely.
...
DATASET_PATH = "/data-1/dataset/dpo/dpo-4b-v2/dpo-4b-v2-pairs.jsonl"
OUTPUT_DIR = "/data-1/checkpoints/qwen3-4b-base-dpo-v2"
LOG_DIR = "/data-1/checkpoints/qwen3-4b-base-dpo-v2/training_logs"

# Training hyperparameters (same as proven 4B settings)
BETA = 0.1
LEARNING_RATE = 5e-7
NUM_EPOCHS = 1
...
def main():
    print("=" * 70)
    print("Qwen3-4B DPO Training (v2 - strict preference pairs)")
    print("=" * 70)
