"""
DPO Training script for Gemma3-4B-PT (base model) with DeepSpeed ZeRO 2.
...
Usage (inside dpo-harness Docker container):
    accelerate launch --config_file trl/accelerate_configs/zero2.yaml \
        dpo_pipeline/train_dpo_gemma3_4b_base.py
"""
...
DATASET_PATH = "/data-1/dataset/dpo/dpo-gemma3-4b-base/dpo-gemma3-4b-base-pairs.jsonl"
OUTPUT_DIR = "/data-1/checkpoints/gemma3-4b-base-dpo"
LOG_DIR = "/data-1/checkpoints/gemma3-4b-base-dpo/training_logs"
...
def main():
    print("=" * 70)
    print("Gemma3-4B-PT DPO Training (DeepSpeed ZeRO 2)")
    print("=" * 70)
