...
EVAL_TEST_FILES="${DATASET_DIR}/EnsembleLLM-data-processed/HumanEval/test.jsonl ${DATASET_DIR}/EnsembleLLM-data-processed/MBPP/test.jsonl ${DATASET_DIR}/EnsembleLLM-data-processed/BigCodeBench/test.jsonl"
