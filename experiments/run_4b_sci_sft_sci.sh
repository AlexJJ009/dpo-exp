#!/usr/bin/env bash
# Qwen3-4B Sci-SFT + MedMCQA (cross-domain)
MODEL="/data-1/.cache/Qwen3-4B-Base-Sci-SFT/checkpoint-109"
TRAIN_DATA="/data-1/dataset/dpo/scienceqa/scienceqa-train.jsonl"
EXP_NAME="dpo-4b-sci-sft-sci"
CHECKPOINT_DIR="/data-1/checkpoints/qwen3-4b-sci-sft-dpo-sci"
