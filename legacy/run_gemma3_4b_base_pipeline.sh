#!/usr/bin/env bash
#
# Full pipeline for Gemma3-4B-PT (base model) DPO
#
# Steps:
...
#
# Usage:
#   bash run_gemma3_4b_base_pipeline.sh 2>&1 | tee run_gemma3_4b_base_pipeline.log
#
set -euo pipefail

# ==================== Configuration ====================
OUTPUT_PREFIX="dpo-gemma3-4b-base"
MODEL="google/gemma-3-4b-pt"
CHECKPOINT_DIR="/data-1/checkpoints/gemma3-4b-base-dpo"
EVAL_OUTPUT_DIR="${CHECKPOINT_DIR}/inference_n3"
TRAIN_SCRIPT="dpo_pipeline/train_dpo_gemma3_4b_base.py"
...
echo "============================================================"
echo "  Gemma3-4B-PT DPO Full Pipeline (DeepSpeed ZeRO 2)"
echo "============================================================"
echo ""
echo "  Model:            ${MODEL}"
...
# Use a marker file to track cleaning completion
