#!/usr/bin/env bash
#
# Full pipeline for Gemma3-4B-SFT DPO
#
# Steps:
#   1. Generate preference pairs with --strict (using SFT model for rollout)
#   2. Clean pairs (re-verify rejected responses)
#   3. Train DPO with DeepSpeed ZeRO 2 (8 GPUs)
#   4. Evaluate on 7 math benchmarks (n=3)
#
# Usage:
#   bash run_gemma3_4b_sft_pipeline.sh
#
set -euo pipefail
...
echo "============================================================"
echo "  Gemma3-4B-SFT DPO Full Pipeline (DeepSpeed ZeRO 2)"
echo "============================================================"
echo ""
echo "  Model:            ${MODEL}"
