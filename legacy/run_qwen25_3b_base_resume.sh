#!/usr/bin/env bash
#
# Resume Qwen2.5-3B DPO pipeline from Step 3 (Step 1 & 2 already completed).
#
# Step 1 complete: 10298 preference pairs at
#   /data-1/dataset/dpo/dpo-qwen25-3b-base/dpo-qwen25-3b-base-pairs.jsonl
#
set -euo pipefail
