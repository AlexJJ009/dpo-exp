"""
DPO Training script for Qwen2.5-3B (base model) with DeepSpeed ZeRO 2.
...
DATASET_PATH = "/data-1/dataset/dpo/dpo-qwen25-3b-base/dpo-qwen25-3b-base-pairs.jsonl"
OUTPUT_DIR = "/data-1/checkpoints/qwen25-3b-base-dpo"
LOG_DIR = "/data-1/checkpoints/qwen25-3b-base-dpo/training_logs"
...
def main():
    print("=" * 70)
    print("Qwen2.5-3B DPO Training (DeepSpeed ZeRO 2)")
    print("=" * 70)
