#!/usr/bin/env bash
#
# Resume Gemma3-4B-PT DPO pipeline from Step 3 (Step 1 & 2 already completed).
#
# Step 1 complete: 10781 preference pairs at
#   /data-1/dataset/dpo/dpo-gemma3-4b-base/dpo-gemma3-4b-base-pairs.jsonl
#
set -euo pipefail
